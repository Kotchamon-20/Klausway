...
export function BlogGrid({ hideHeader = false }: BlogGridProps) {
  return (
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {blogPosts.map((post, i) => (
            <Reveal
              ...
              className="hover-lift group flex flex-col rounded-2xl border border-white/5 bg-card/40 p-6 backdrop-blur transition-all hover:border-white/10 hover:bg-card/60"
            >
              <time
                dateTime={post.date}
